...
**La subred 1** de clase C tiene 4 ordenadores con IP fija que puede ir desde la 192.168.0.1 hasta la 192.168.0.126 con máscara de red 255.255.255.128, en esta red no he configurado puerta de enlace, ya que estos no salen fuera y esta es su  configuración
...
**La subred 2** de clase C tiene 4 ordenadores con IP fija que puede ir desde la 192.168.0.129 hasta la 192.168.0.158 con máscara de red 255.255.255.224, en esta red tampoco he configurado puerta de enlace, ya que tampoco puede acceder fuera y esta es su configuración:
...
**La subred 3** de clase C tiene 4 ordenadores con IP fija que puede ir desde la 192.168.0.161 hasta la 192.168.0.166 con máscara de red 255.255.255.166, y esta es su configuración.

![](http://lengmarjorge.webcindario.com/imagenes/subred3.jpg)

Esta red tiene puerta de enlace 192.168.0.162 ya que puede salir fuera
En esta imagen podemos ver la configuración de uno de sus ordenadores:
...
Esta red la he dotado de un servidor con DHCP configurado para que administre a los ordenadores de una red de clase C desde la IP 192.168.1.1 hasta la 192.168.1.245, con máscara de red 255.255.255.0. En este servidor he configurado la puerta de enlace predeterminada 192.168.1.10 para que todos los ordenadores puedan acceder al router y el servidor DNS 192.168.10.5 para que puedan acceder al servidor que aloja las páginas WEB.
...
Esta red es similar a la descrita anteriormente, la he dotado de un servidor con DHCP configurado para que administre la red de clase C desde la IP 192.168.3.1 hasta la 192.168.3.245, con máscara de red 255.255.255.0. En este servidor he configurado la puerta de enlace predeterminada 192.168.3.19 para que todos los ordenadores puedan acceder al router y el servidor DNS 192.168.10.5 para que puedan acceder al servidor que aloja las páginas WEB. 
La configuración del servidor es:
...
Por lo tanto nos quedaría así la red 3:
...
En esta he montado 4 ordenadores en la red de clase C 192.168.2.X y máscara de red 255.255.255.0. En esta red he configurado la puerta de enlace predeterminada 192.168.2.2 en cada uno de los ordenadores con IP fija y el servidor DCHP para que todos los ordenadores puedan acceder al router y el servidor DNS 192.168.10.5 para que puedan acceder al servidor que aloja las páginas WEB.
...
Esta red es muy similar a la primera que he descrito cada uno de los ordenadores tendría una IP fija dentro de la red de clase C 192.168.4.X y máscara de red 255.255.255.0. En esta red he configurado la puerta de enlace predeterminada 192.168.4.2 en cada uno de los ordenadores con IP fija para que puedan acceder al router y el servidor DNS 192.168.10.5 para que puedan acceder al servidor que aloja las páginas WEB.la configuración de uno de ellos es:
